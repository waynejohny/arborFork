...
(function($){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['arbor.js','code','docs','plattforms']) >=0 ){
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{sharepoint:{color:"red", shape:"dot", alpha:1}, 
      
			plattforms:{color:CLR.branch, shape:"dot", alpha:1}, 
				plattform1:{color:CLR.demo, alpha:0},
					server1:{color:CLR.demo, alpha:0, link:'/halfviz'},
					server2:{color:CLR.demo, alpha:0, link:'/halfviz'},
					server3:{color:CLR.demo, alpha:0, link:'/halfviz'},
				plattform2:{color:CLR.demo, alpha:0},
				plattform3:{color:CLR.demo, alpha:0},
